...
<div class="row" >
    ...
    <p align="left" class="help-block"> (*) Obligatorio </p><br>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                @if( isset($preparacionSector))
                {!!Form::text('numPasadas' ,$preparacionSector->numPasadas,['class'=>'form-control','id'=>'numPasadas','placeholder'=>'Número de pasadas'])!!}
                @else
                    {!!Form::text('numPasadas' ,null,['class'=>'form-control','id'=>'numPasadas','placeholder'=>'Número de pasadas'])!!}
                @endif
            </div>
        </div>
