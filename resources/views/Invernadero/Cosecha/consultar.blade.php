                        ...
                        <div class="form-panel">
                            ...
                            @if( isset($cosechaInvernadero))
                                ...
                                <table align="right">
                                    <tr>
                                        <td>
                                            <a href="{{ route('invernadero/cosecha/modificar/item',$cosechaInvernadero->id) }}"><button class="btn btn-primary btn-xs tooltips" data-placement="top" data-original-title="Modificar"><i class="fa fa-pencil"></i></button></a>
                                            &nbsp
                                        </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Transplante</dt><dd>{{ $cosechaInvernadero->siembraTransplante->variedad }}, {{ $cosechaInvernadero->siembraTransplante->cultivo->nombre }}</dd>
