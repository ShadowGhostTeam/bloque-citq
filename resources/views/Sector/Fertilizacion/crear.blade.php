                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            {!! Form::open(['action'=>['fertilizacionSectorController@crear'],'class'=>'form-horizontal','role'=>'form','id'=>'formulario'])!!}

                            <h4 style="color:#078006"><i class="fa fa-angle-right"></i>Crear fertilización</h4><br>
