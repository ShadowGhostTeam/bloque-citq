                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <div class="form-group" align="right">
                                <a href="{{route('sector/siembra/crear')}}"> <button class="btn agregar tooltips" data-placement="left" data-original-title="Agregar"><i class="fa fa-plus"></i></button></a>
                            </div>
                                        ...
                                        @if ( isset( $siembras) )
                                            @foreach( $siembras as $siembra)
                                                <tr>
                                                    ...
                                                    <td style="width: 5px">
                                                        <a href="{{ route('sector/siembra/consultar/item', $siembra->id) }}">
                                                    ...
                                                    <td style="width: 5px">
                                                        <a href="{{ route('sector/siembra/modificar/item', $siembra->id) }}">
                                                            <button class="btn btn-primary btn-xs tooltips" data-placement="top" data-original-title="Modificar">
