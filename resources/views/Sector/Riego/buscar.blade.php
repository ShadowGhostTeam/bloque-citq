                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <div class="form-group" align="right">
                                <a href="{{route('sector/riego/crear')}}"> <button class="btn agregar tooltips" data-placement="left" data-original-title="Agregar"><i class="fa fa-plus"></i></button></a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    {!! Form::open(['route' => 'sector/riego/lista','method'=>'GET']) !!}
                                ...
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    @if ( isset( $riegos) )
                                        ...
                                        @foreach( $riegos as $riego)
                                            ...
                                            <tr>
                                                <td>{{ $riego->sector->nombre }}</td>
                                                <td>{{ $riego->tiempo }} horas</td>
                                                <td>{{ $riego->distanciaLineas }} metros</td>
                                                <td>{{ $riego->litrosHectarea }} litros</td>
                                                <td>{{ $riego->lamina }} mm de agua</td>
                                                <td>{{ $riego->fecha }}</td>

                                                <td style="width: 5px">
                                                    <a href="{{ route('sector/riego/consultar/item',$riego->id) }}"><button class="btn btn-success btn-xs tooltips" data-placement="top" data-original-title="Consultar"><i class="fa fa-eye"></i></button></a>
                                                </td>
