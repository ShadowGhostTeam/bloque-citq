                        ...
                        <div class="form-panel">
                            ...
                            @if( isset($riegoSector))
                                ...
                                <table align="right">
                                    <tr>
                                        <td>
                                            <a href="{{ route('sector/riego/consultar/item',$riegoSector->id) }}">
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="id" value={{$riegoSector->id}}>
                                            {!! Form::close() !!}
                            ...
                            {!! Form::open(['action'=>['riegoSectorController@modificar'],'class'=>'form-horizontal','role'=>'form', 'id' =>'formulario'] )  !!}
