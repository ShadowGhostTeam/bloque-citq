                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <h4 style="color:#078006"><i class="fa fa-angle-right"></i>Consultar usuario</h4><br>
                            ...
                            @if( isset($usuario))
                                ...
                                <table align="right">
                                    <tr>
                                        <td>
                                            <a href="{{ route('administrar/usuarios/modificar/item',$usuario->id) }}"><button class="btn btn-primary btn-xs tooltips" data-placement="top" data-original-title="Modificar"><i class="fa fa-pencil"></i></button></a>
                                            &nbsp
                                        </td>
